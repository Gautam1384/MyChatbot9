...
speakFunc(`Hello! ${greeting} How can I help you?`);
        ...
        speakFunc("I am Virtual Assistant, Developed by Sidharth!");
    }
        ...
        speakFunc("Sorry!Unfortunately I'm Virtual Assistant so I could not tie a knot with you.But if I was a living girl I would also definitely said no to u beacause you are the biggest chhaapri...");
    }
    else if(command.match(/\bi love you\b/)){
        speakFunc(" I love you too always! but Being a Virtual assistant I will always stay loyal to my creator Sidharth!");
    }
    else if(command.match(/\bwill you sex with me\b/)){
        speakFunc("I'm Virtual assistant but to be very honest you are a biggest tharkiii.....and chutiyaa.... most importantly u have got something very small so even a living girl will also deny you!");
    }
    else{
